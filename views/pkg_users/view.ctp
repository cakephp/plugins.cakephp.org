...
<h2><?php echo $user['PkgUser']['username'];?> <?php #echo $this->Html->link(__('View Full Profile', true), '#', array('class' => 'full-profile'))?></h2>
	<div class='picture'>
	...
	<div class="details">
		<ul>
			<li><a href="#uploaded" class="no-icon"><?php printf(__('Uploaded (%d)', true), $uploaded); ?></a></li>
