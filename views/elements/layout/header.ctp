			...
			<div class="login">
				<?php 
					if (!$this->Session->check('Auth.User.id')) {
						echo $this->Html->link(__('Login', true), array('admin' => false, 'plugin' => false, 'controller' => 'pkg_users', 'action' => 'login')) . ' ';
						echo $this->Html->link(__('Register', true), array('admin' => false, 'plugin' => false, 'controller' => 'users', 'action' => 'register')) . ' ';
					} else {
						...
						echo $this->Html->link(__('Logout', true), array('admin' => false, 'plugin' => false, 'controller' => 'users', 'action' => 'logout')) . ' ';
					}
				?>
			</div>
		</div>
