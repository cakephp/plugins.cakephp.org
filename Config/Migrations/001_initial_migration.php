<?php
class M4cda015d943c4b6f978c2004cbdd56cb extends CakeMigration {
 ...
 */
	public $migration = array(
		'up' => array(
			'create_table' => array(
				...
				'packages' => array(
					...
					'indexes' => array(
						'PRIMARY' => array('column' => 'id', 'unique' => 1),
						'package_record' => array('column' => array('name', 'maintainer_id', 'deleted'), 'unique' => 1),
						'name' => array('column' => 'name', 'unique' => 0),
		...
		'down' => array(
			'drop_table' => array(
				'blog_posts', 'maintainers', 'packages', 'packages_tags', 'search_index', 'settings', 'tags'
			),
		),
	);
