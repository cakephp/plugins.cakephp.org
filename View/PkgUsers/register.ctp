...
<div class="help sidebar">
	...
	<p><?php
		echo sprintf(
			__('If you are already registered in any of the CakePHP community sites, you just need to %s using your email address and passowrd'),
...
<?php
	$this->set('title_for_layout', __('Become a Member'));
