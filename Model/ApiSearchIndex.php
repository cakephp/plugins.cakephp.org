 ...
 */
	public function __construct($id = false, $table = null, $ds = null) {
		...
		$this->findMethods['search'] = true;
		$this->findMethods['types'] = true;
	}
 ...
 */
	public function getHashedMapping() {
		$response = array();
 ...
 * @return mixed array of results or false if none found
 */
	public function _findTypes($state, $query, $results = array()) {
		if ($state == 'before') {
			$query['fields'] = array(
